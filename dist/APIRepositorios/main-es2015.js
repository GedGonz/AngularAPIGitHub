...
let RepositoriosComponent = class RepositoriosComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
let RepositoriosService = class RepositoriosService {
    constructor(http) {
        this.http = http;
    }
    getOwner(name) {
...
RepositoriosService.ctorParameters = () => [
